...
(ns editor.editor-extensions.coerce
  ...
  (:refer-clojure :exclude [boolean integer hash-map vector-of keyword])
...
(def keyword
  "Keyword coercer, converts Lua strings into Clojure keywords"
  (wrap-transform string clojure.core/keyword))
